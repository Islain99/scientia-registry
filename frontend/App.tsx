...
const AppContent: React.FC = () => {
  ...
  useEffect(() => {
    lsSet('scientia_entries', JSON.stringify(entries));
  }, [entries]);

  useEffect(() => {
    lsSet('scientia_progress', JSON.stringify(userProgress));
  }, [userProgress]);

  useEffect(() => {
    lsSet('scientia_favorites', JSON.stringify(favorites));
  }, [favorites]);

  useEffect(() => {
    lsSet('scientia_role', userRole);
  }, [userRole]);
